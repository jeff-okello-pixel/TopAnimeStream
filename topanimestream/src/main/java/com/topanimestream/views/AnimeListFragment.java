...
public class AnimeListFragment extends Fragment {
    ...
    public void GetAnimes(String customOrder, String customFilter)
    {
        ...
        if(mMode == Mode.NORMAL) {
            ...
            String url = getString(R.string.odata_path) + "Animes?$expand=Genres,AnimeInformations,Status&$skip=" + currentSkip + "&$top=" + currentLimit + "&$filter=startswith(tolower(OriginalName),%20%27" + searchQuery.toLowerCase() + "%27)&$orderby=IsAvailable%20desc&$count=true";
            CallService(url);
        }
    }
