...
public class Mirror implements Parcelable {
    ...
    public Mirror(int mirrorId, int episodeId, int animeSourceId, int partNumber, String addedDate, String source, int reportCount, boolean isVisible, urf.animestream.models.AnimeSource animeSource, Provider provider) {
        MirrorId = mirrorId;
        EpisodeId = episodeId;
