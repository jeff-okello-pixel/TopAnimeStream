package urf.animestream.managers;
    ...
    public static void ShowChromecastNotProErrorDialog(final Context context){
        ...
        builder.setPositiveButton(context.getString(R.string.action_buypro),
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        try {
                            context.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=urf.animestream.pro")));
                        } catch (android.content.ActivityNotFoundException anfe) {
                            context.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("http://play.google.com/store/apps/details?id=urf.animestream.pro")));
                        }
                    }
                });
        builder.setNegativeButton(context.getString(R.string.cancel),
