package org.topanimestream.managers;
...
import org.topanimestream.App;
import org.topanimestream.Utils;
...
public class DialogManager {
    ...
    public static void ShowUpdateDialog(final Context context, final org.topanimestream.models.Package pkg){
        ...
        if(App.isGooglePlayVersion && !App.isPro)
        {
            ...
            builder.setNeutralButton(context.getString(R.string.spanish_only),
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            try {
                                context.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=org.topanimestream.pro")));
                            } catch (android.content.ActivityNotFoundException anfe) {
                                context.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("http://play.google.com/store/apps/details?id=org.topanimestream.pro")));
                            }
                        }
                    });
            builder.setNegativeButton(context.getString(R.string.cancel),
