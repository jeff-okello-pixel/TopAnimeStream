...
public class Vk implements Parcelable {
    ...
    public Vk(JSONObject jsonVk)
    {
        try {
            if(!jsonVk.isNull("AnimeSource"))
                this.AnimeSource = new org.topanimestream.models.AnimeSource(jsonVk.getJSONObject("AnimeSource"));
    ...
    public Vk(org.topanimestream.models.AnimeSource animeSource, int vkId, int animeSourceId, String quality, String source, int episodeId, String addedDate) {
