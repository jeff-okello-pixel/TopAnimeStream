...
public class Mirror implements Parcelable {
	...
	private org.topanimestream.models.AnimeSource AnimeSource;
	private Provider provider;
	public Mirror() {
		super();
	}

    public Mirror(int mirrorId, int episodeId, int animeSourceId, int partNumber, String addedDate, String source, int reportCount, boolean isVisible, org.topanimestream.models.AnimeSource animeSource, Provider provider) {
        MirrorId = mirrorId;
        EpisodeId = episodeId;
	...
	public Mirror(JSONObject jsonMirror)
	{
		try
		{
            if(!jsonMirror.isNull("AnimeSource"))
			    this.AnimeSource = new org.topanimestream.models.AnimeSource(jsonMirror.getJSONObject("AnimeSource"));
    ...
    public Mirror(Parcel in) {
    	AnimeSource = (org.topanimestream.models.AnimeSource) in.readParcelable(org.topanimestream.models.AnimeSource.class.getClassLoader());
	...
	public org.topanimestream.models.AnimeSource getAnimeSource() {
		return AnimeSource;
	}
	public void setAnimeSource(org.topanimestream.models.AnimeSource animeSource) {
		AnimeSource = animeSource;
	}
